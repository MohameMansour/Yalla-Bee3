...
public class SignUpEmaratActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_up_emarat);
...
//        Toast.makeText(this, "" + allcountry, Toast.LENGTH_SHORT).show();
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter
                .createFromResource(this, R.array.conutryemarat
...
//                            updateUI(user);
                            ...
                            Toast.makeText(SignUpEmaratActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
...
//                            updateUI(null);
    ...
    private void saveUser(final FirebaseUser user, final Uri uri) {
        ...
        if (uri == null) {
            ...
            progressDialog.dismiss();
            Intent i = new Intent(SignUpEmaratActivity.this, SignInActivity.class);
            startActivity(i);
            // Missing code
            if (DeviceLang.equals("ar")) {
                Toast.makeText(SignUpEmaratActivity.this, "تهانينا,سجل دخولك الان", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(SignUpEmaratActivity.this, "Congratulation,Sign In Now", Toast.LENGTH_SHORT).show();
            }
            finish();
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    storageReference.child("User").child("Images").child(userId + "/" + imageName).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            databaseReference.child("User").child(userId).setValue(newUser);
                            // Missing code
//                        Intent i = new Intent(SignUpEmaratActivity.this , NavActivity.class);
...
//                        startActivity(i);
                            ...
                            startActivity(i);
                            if (DeviceLang.equals("ar")) {
                                Toast.makeText(SignUpEmaratActivity.this, "سجل دخولك الان", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(SignUpEmaratActivity.this, "Sign In Now", Toast.LENGTH_SHORT).show();
                            }
                            finish();
